        ...
        <div className='flex items-center justify-between lg:flex-col lg:gap-7'>
            <div className='grid items-center sm:text-center'>
                ...
                <p className='text-base sm:text-sm
                 xsm:text-xs font-medium'>Questions and Feedback? we would love to hear for you</p>
            </div>
                <form className='flex items-center justify-center relative'>
                    ...
                    <button type='button' className='text-base px-5 py-2 text-white bg-gradient-to-b from-emerald-500 to-green-500 rounded-r-full transition-all duration-300 active:scale-90 absolute right-0 shadow-lg shadow-emerald-400'>Submit</button>
                        </form>
            </div>
        </div>
