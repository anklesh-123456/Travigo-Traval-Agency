  ...
  return (
    ...
    <div className='flex flex-col bg-gradient-to-b from-emerald-200 to-white h-auto w-auto'>
        <div className='travigo-container grid items-start justify-items-center'>
            <div className='grid items-center justify-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12'>
            ...
            <div className='flex items-center justify-center mb-11'>
                <img src={img} alt="dashbord/img" className='h-[85vh] w-full object-fill lg:h-[75vh] md:h-[57vh] sm:h-[35vh] sm:object-contain drop-shadow-emrald'/>
            </div>
        </div>
    </div>
    </>
